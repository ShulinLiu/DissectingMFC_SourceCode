...
Resource3=IDR_GGGTYPE

[CLS:CGggApp]
Type=0
HeaderFile=ggg.h
ImplementationFile=ggg.cpp
Filter=N

[CLS:CGggDoc]
Type=0
HeaderFile=gggDoc.h
ImplementationFile=gggDoc.cpp
Filter=N

[CLS:CGggView]
Type=0
HeaderFile=gggView.h
ImplementationFile=gggView.cpp
Filter=C
